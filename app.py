...
from parent import parent_bp, init_parent
app.register_blueprint(parent_bp)

from dev_guide import dev_guide_bp
app.register_blueprint(dev_guide_bp)
...
@app.route('/parent')
def parent_portal():
    return send_from_directory('pages', 'parent.html')
